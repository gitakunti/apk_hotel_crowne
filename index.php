...
<html lang="en">
<head>
  <title>WELCOME - HOTEL CROWNE</title>
  <meta charset="utf-8">
...
<div class="p-2 bg-secondary text-white text-center">
  <h1>HOTEL CROWNE</h1>
  <p>Selamat datang di Hotel Crowne Jember Indonesia!</p> 
</div>
<!------------------AKHIR BAGIAN HEADER----------------- -->
...
<nav class="navbar navbar-expand-sm navbar-dark bg-primary">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">@CROWNE</a>
          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <h5><a class="nav-link" href="index2.php" id="tombol_fasilitas">Login</a></h5>
            </li>
          </ul>     
...
<div class="container mt-2" id="panel_fasilitas_kami">
    <h2 class="text-center" >FASILITAS KAMI</h2>
      <h5 class="text-center">Hotel Crowne</h5>
  ...
  <div class="d-flex justify-content-center">
    <div class="row">
     <div class="col-sm-12 p-5">
      ...
      <p> <b>Hotel Crowne</b> Terletak di jl. Mataram di pusat kota Jember. Menyediakan kamar ber-AC dengan WIFI gratis. Akomodasi ini memiliki sebuah kolam renang luar ruangan, serta restoran yang berada di rooftop.
    </p>
   </div>
  </div>
